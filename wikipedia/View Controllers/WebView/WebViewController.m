...
-(void)downloadAssetsFilesIfNecessary
{
    ...
    [QueuesSingleton sharedInstance].assetsFetchManager.responseSerializer = [AFHTTPResponseSerializer serializer];
                    ...
                    discoveryMethod: (NSString *)discoveryMethod
{
    ...
    [articleDataContext_.mainContext performBlockAndWait:^(){
        ...
        (void)[[ArticleFetcher alloc] initAndFetchArticle: article
