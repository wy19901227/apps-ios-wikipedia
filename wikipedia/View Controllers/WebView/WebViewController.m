                    ...
                    discoveryMethod: (NSString *)discoveryMethod
{
    ...
    // Means "downloadFinishedForArticle:result:type:error:" above will
    // be notified when article's "download" method has actually
    // retrieved some data.
    article.delegate = self;
    // Kick off the download.
    [article downloadWithManager:[QueuesSingleton sharedInstance].articleRetrievalManager];
}
