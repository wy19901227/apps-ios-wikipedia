...
-(void)setEditToken:(NSString *)editToken
{
    [self setKeychainValue:editToken forEntry:@"org.wikimedia.wikipedia.edittoken"];
}
...
-(NSString *)editToken
{
    return [self getKeychainValueForEntry:@"org.wikimedia.wikipedia.edittoken"];
}
